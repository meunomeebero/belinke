    ...
    <>
      <div className="w-96 min-w-96 h-full flex flex-col 
        ...
        <div className="p-6 border-b border-gray-200 dark:border-b-[#282B36]">
          ...
          <p className="text-sm text-gray-500 dark:text-[#ADADAD] mt-1">
            🐝 Belinke
          </p>
        </div>
      ...
      {/* Floating Action Buttons (Download & Save) */}
      <div className="fixed top-6 right-6 z-50 flex space-x-3">
        <Button 
          aria-label="Baixar PNG do Perfil"
          className="p-3 flex items-center justify-center bg-slate-700 text-slate-200 hover:bg-slate-600 focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900 focus:ring-slate-500 active:animate-bounce-sm rounded-lg shadow-lg"
          onClick={onDownload}
        >
          <Download size={20} />
        </Button>
